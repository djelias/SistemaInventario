...
@section('content')
  ...
  @endif
      <div>
        ...
        {!! Form::open(['route'=>'tableVentas.index', 'method'=>'GET', 'class'=>'navbar-form pull-right', 'role'=>'search'])!!}
  ...
  <table class="table table-striped" style="text-align:center" >
    ...
    <tr>
        ...
        <td>
          ...
          <a class="btn btn-primary btn-lg" data-toggle="tooltip" data-placement="top" title="Editar" href="{{route('tableVentas.edit',$value->id)}}">
              <i class="glyphicon glyphicon-pencil"></i></a>
            {!! Form::open(['method' => 'DELETE','route' => ['tableVentas.destroy', $value->id],'style'=>'display:inline']) !!}
